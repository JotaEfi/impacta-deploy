...
class Donation(models.Model):
    org = models.ForeignKey(
        Ong, on_delete=models.CASCADE, related_name="received_donations"
    )
    item = models.ForeignKey(
        Item, on_delete=models.SET_NULL, null=True, related_name="donations"
    )
    donor = models.ForeignKey(
        CustomUser, on_delete=models.SET_NULL, null=True, related_name="made_donations"
    )
...
class Avaliation(models.Model):
    ...
    donor = models.ForeignKey(
        CustomUser, on_delete=models.SET_NULL, null=True, related_name="avaliations"
    )
...
class Faq(models.Model):
    org_user = models.ForeignKey(
        CustomUser, on_delete=models.CASCADE, related_name="faqs"
    )
...
class PaymentInfo(models.Model):
    org = models.OneToOneField(
        Ong, on_delete=models.CASCADE, related_name="payment_info"
    )
...
class DonationReport(models.Model):
    donation = models.ForeignKey(
        Donation, on_delete=models.CASCADE, related_name="reports"
    )
...
class Accountability(models.Model):
    org = models.ForeignKey(
        Ong, on_delete=models.CASCADE, related_name="accountabilities"
    )
